    ...
    return [
        ...
        (
            ...
            (
                ...
                "against the model's every gameweek) and the season race "
                "against the model's own squad, which is locked before every "
                "deadline and scored with official FPL points, a watchlist for the "
                ...
                "differently, player compare for up to four "
...
<div class="cta-row">
  <a class="cta" href="{PRO_CHECKOUT_SEASON_URL}" data-cta="fpl">Start Premium with code EARLY30, &euro;17.50</a>
</div>
<p class="price-note"><strong>Enter EARLY30 at checkout</strong> before the GW1 deadline on Friday
21 August: 30% off the first year, €17.50 instead of €25. It renews at €25 a year (under €2.10 a
