    ...
    return [
        ...
        (
            ...
            (
                ...
                "planned squad, player value (xP per million) for the top 50 with position and team filters, a live DefCon "
...
def jsonld_blocks(c: dict, faq: list[tuple[str, str]]) -> str:
    ...
    app = {
        ...
        "description": (
            ...
            "million) for the top 50 with position and team filters, xG "
